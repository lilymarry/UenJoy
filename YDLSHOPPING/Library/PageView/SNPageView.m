...
- (instancetype)initWithFrame:(CGRect)frame p_style:(PageViewStyle)p_style {
    ...
    if (self) {
        ...
        _titleNormalColor = Color(@"#999999");
        _titleSelectedColor = Color(@"#333333");
...
- (UIScrollView *)topScrollView {
    if (!_topScrollView) {
        _topScrollView = [[UIScrollView alloc] initWithFrame:CGRectMake(0, 0, _pageFrame.size.width, _tilteHeght-0.5)];
        ...
        [self addSubview:_topScrollView];
          ...
          UIView *line=[[UIView alloc]initWithFrame:CGRectMake(0, _tilteHeght-1, ScreenWidth, 0.5)];
