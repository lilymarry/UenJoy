...
// Constants :
static NSString  * const kSureButtonItemTitle = @"Sure";
static NSString  * const kCancelButtonItemTitle = @"Cancel";
...
static CGFloat const kHooDatePickerButtonHeaderWidth = 60.0f;
