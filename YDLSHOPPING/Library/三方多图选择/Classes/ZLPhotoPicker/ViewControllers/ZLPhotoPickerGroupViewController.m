...
- (void) setupButtons{
    UIBarButtonItem *barItem = [[UIBarButtonItem alloc] initWithTitle:@"Closed" style:UIBarButtonItemStyleDone target:self action:@selector(back)];
