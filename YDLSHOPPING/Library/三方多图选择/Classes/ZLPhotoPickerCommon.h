...
static NSString *PICKER_PowerBrowserPhotoLibirayText = @"You have blocked the permission to select album. Please go to system settings - > Privacy - > my app to open the permission";
